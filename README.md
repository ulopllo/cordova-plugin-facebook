...
```bash
$ cordova plugin add https://github.com/zhoumo99133/cordova-plugin-facebook --save --variable APP_ID="123456789" --variable APP_NAME="myApplication"
```
...
`setUserId(String userId, Function success, Function failure)`

### GetUserId

`getUserId(Function success, Function failure)`

### ClearUserId

`clearUserId(Function success, Function failure)`
